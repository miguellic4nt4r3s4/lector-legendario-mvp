...
export function WorldMap({ xp, aventurasCompletadas = [] }: { xp: number; aventurasCompletadas?: number[] }) {
  ...
  return <section className="relative overflow-hidden rounded-lg border border-accent/40 bg-card/45 p-5 shadow-2xl backdrop-blur-sm sm:p-7" aria-labelledby="titulo-mapa-reino">
    ...
    <div className="relative"><p className="text-xs font-bold uppercase text-accent">Ruta de la leyenda</p><h2 id="titulo-mapa-reino" className="mt-1 font-adventure text-3xl text-primary">Mapa del Reino</h2><p className="mt-2 max-w-xl text-sm text-muted-foreground">Seis territorios de lectura. Cada sendero se revela con tu experiencia.</p></div>
