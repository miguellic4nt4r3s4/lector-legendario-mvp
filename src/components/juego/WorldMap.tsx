...
export function WorldMap({ xp, aventurasCompletadas = [] }: { xp: number; aventurasCompletadas?: number[] }) {
  ...
  return <section className="world-map relative isolate min-h-[760px] overflow-hidden px-5 py-14 sm:px-8 lg:min-h-[620px] lg:px-12" aria-labelledby="titulo-mapa-reino">
