...
type Props = { nombre: string; clase: string; xp: number; insignias?: number; className?: string; compacto?: boolean };

export function CharacterCard({ nombre, clase, xp, insignias = 0, className, compacto = false }: Props) {
